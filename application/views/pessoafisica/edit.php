<?php echo form_open('pessoafisica/edit/'.$pessoafisica['IDPessoaFisica'],array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="cpf" class="col-md-4 control-label">Cpf</label>
		<div class="col-md-8">
			<input type="text" name="cpf" value="<?php echo ($this->input->post('cpf') ? $this->input->post('cpf') : $pessoafisica['cpf']); ?>" class="form-control" id="cpf" />
		</div>
	</div>
	<div class="form-group">
