...
<div class="card">
    ...
    <div class="container-fluid">
        <div class="card-body"> 
            ...
            <div class="col-md-8">
                   <label for="IDCliente" class="col-md-4 control-label">Cliente</label>
                <select id="selecione" name="IDCliente" class="form-control ">
                    <option value="">Selecione o Cadastro</option>
                    <?php 
                    foreach($all_pessoas as $pessoa)
                    {
                        $selected = ($pessoa['IDPessoa'] == $this->input->post('IDCliente')) ? ' selected="selected"' : "";
