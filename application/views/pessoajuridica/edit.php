<?php echo form_open('pessoajuridica/edit/'.$pessoajuridica['IDPessoaJuridica'],array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="cnpj" class="col-md-4 control-label">Cnpj</label>
		<div class="col-md-8">
			<input type="text" name="cnpj" value="<?php echo ($this->input->post('cnpj') ? $this->input->post('cnpj') : $pessoajuridica['cnpj']); ?>" class="form-control" id="cnpj" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="tblPessoaJuridicacol" value="<?php echo ($this->input->post('tblPessoaJuridicacol') ? $this->input->post('tblPessoaJuridicacol') : $pessoajuridica['tblPessoaJuridicacol']); ?>" class="form-control" id="tblPessoaJuridicacol" />
		</div>
	</div>
