<?php echo form_open('contato/edit/'.$contato['IDContato'],array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="nome" class="col-md-4 control-label">Nome</label>
		<div class="col-md-8">
			<input type="text" name="nome" value="<?php echo ($this->input->post('nome') ? $this->input->post('nome') : $contato['nome']); ?>" class="form-control" id="nome" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="telRes" value="<?php echo ($this->input->post('telRes') ? $this->input->post('telRes') : $contato['telRes']); ?>" class="form-control" id="telRes" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="telCom" value="<?php echo ($this->input->post('telCom') ? $this->input->post('telCom') : $contato['telCom']); ?>" class="form-control" id="telCom" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="telCel" value="<?php echo ($this->input->post('telCel') ? $this->input->post('telCel') : $contato['telCel']); ?>" class="form-control" id="telCel" />
