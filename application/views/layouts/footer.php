    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?php echo base_url('home/login')?>">Logout</a>
            </div>
        </div>
    </div>
</div>
...
<script src="<?php echo base_url('assets/jQuery-Mask-Plugin/dist/jquery.mask.min.js')?>"></script>
...
<script src="<?php echo base_url('assets/template/js/cliente.js')?>"></script>
